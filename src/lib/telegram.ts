/**
 * Telegram Bot helpers for SOUL restaurant.
...
export function formatReviewMessage(r: {
  ...
  const lines = [
    r.rating === 5 ? `🌟 <b>НОВЫЙ ОТЗЫВ — 5 ЗВЁЗД!</b>` : `💬 <b>Новый отзыв — SOUL</b>`,
    `━━━━━━━━━━━━━━━━`,
    ``,
