        ...
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-20">
          ...
          <div className="order-1 lg:order-2">
            <SectionHeading
              ...
              intro="SOUL — это оазис природы в сердце Москвы. Своды зелени, хрусталь и тёплый свет создают атмосферу, в которой время идёт иначе. Мы соединили авторскую гастрономию, коктейли и живую музыку в одно цельное впечатление."
            />
